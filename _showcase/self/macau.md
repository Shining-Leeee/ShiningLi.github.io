...
<div class="card border-0 shadow-sm" style="border-radius: 8px; overflow: hidden;">
    ...
    <img data-src="{{ 'assets/images/etc/macau.jpg' | relative_url }}" class="lazy w-100" style="aspect-ratio: 4/3; object-fit: cover; border-top-left-radius: 8px; border-top-right-radius: 8px;" src="{{ '/assets/images/etc/macau.jpg' | relative_url }}">
