...
<div class="card border-0 shadow-sm h-100" 
    ...
    <img data-src="{{ '/assets/images/etc/Malaysia.jpg' | relative_url }}" 
         class="lazy w-100" 
         style="aspect-ratio: 3/4; object-fit: cover; border-top-left-radius: 8px; border-top-right-radius: 8px;" 
         src="{{ '/assets/images/etc/Malaysia.jpg' | relative_url }}">
    ...
    <div class="card-body p-3 bg-light d-flex flex-column">
        ...
        <p class="card-text mb-1" style="font-size: 0.9em; color: #444; display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis;">
          My first trip abroad was to Malaysia. It was also the first time I used English to communicate, order food, shop, and so on. Kuala Lumpur is full of tourists from all over the world, and even though we came from different places, we could still communicate together. At that moment, I truly felt that the world was before me.
        </p>
        <!-- 引导点击的加粗提示 -->
...
<!-- ⚠️ 重点：每张照片的 id 必须唯一！ -->
<div class="modal fade" id="modal-Malaysia" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content shadow-lg" style="border-radius: 12px; overflow: hidden; border: none;">
            ...
            <img src="{{ '/assets/images/etc/Malaysia.jpg' | relative_url }}" class="w-100" style="max-height: 70vh; object-fit: contain; background-color: #f0f0f0;">
