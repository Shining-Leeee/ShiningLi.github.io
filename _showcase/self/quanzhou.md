...
<div class="card border-0 shadow-sm h-100" 
     ...
     data-toggle="modal" data-target="#modal-quanzhou"
    ...
    <img data-src="{{ '/assets/images/etc/quanzhou.jpg' | relative_url }}" 
         class="lazy w-100" 
         style="aspect-ratio: 3/4; object-fit: cover; border-top-left-radius: 8px; border-top-right-radius: 8px;" 
         src="{{ '/assets/images/etc/quanzhou.jpg' | relative_url }}">
    ...
    <div class="card-body p-3 bg-light d-flex flex-column">
        ...
        <p class="card-text mb-1" style="font-size: 0.9em; color: #444; display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis;">
           In 2024, I came to Quanzhou and experienced the local flower-wearing culture. This culture is called "Xunpu Women's Flower-Wearing Garment", a traditional folk custom that has been passed down for thousands of years in Xunpu Village, Fengze District, Quanzhou City, Fujian Province. It was listed as a national intangible cultural heritage in 2008.
        </p>
        <!-- 引导点击的加粗提示 -->
...
<!-- ⚠️ 重点：每张照片的 id 必须唯一！ -->
<div class="modal fade" id="modal-quanzhou" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content shadow-lg" style="border-radius: 12px; overflow: hidden; border: none;">
            ...
            <img src="{{ '/assets/images/etc/quanzhou.jpg' | relative_url }}" class="w-100" style="max-height: 70vh; object-fit: contain; background-color: #f0f0f0;">
