...
<div class="card border-0 shadow-sm" style="border-radius: 8px; overflow: hidden;">
    ...
    <img data-src="{{ 'assets/images/etc/shanghai.jpg' | relative_url }}" class="lazy w-100" style="border-top-left-radius: 8px; border-top-right-radius: 8px;" src="{{ '/assets/images/etc/shanghai.jpg' | relative_url }}">
